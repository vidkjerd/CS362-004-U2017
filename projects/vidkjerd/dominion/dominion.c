...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		return adventureCard(state, currentPlayer, drawntreasure, cardDrawn, z, temphand);
			
    case council_room:
		return councilRoomCard(state, currentPlayer, handPos, i);
			
    case feast:
		return feastCard(state, temphand, currentPlayer, i, x, choice1);
    ...
    case smithy:
		return smithyCard(state, currentPlayer, handPos, cardDrawn, i);
...
int smithyCard(struct gameState* state, int currentPlayer, int handPos, int cardDrawn, int i)
{
	//+3 Cards
      for (i = 0; i < 3; i++)
	{
...
int feastCard(struct gameState* state, int temphand[], int currentPlayer, int i, int x, int choice1)
{
...
int councilRoomCard(struct gameState* state, int currentPlayer, int handPos, int i)
{
	//+4 Cards
      for (i = 0; i < 4; i++)
	{
